...
%% Change
-define(Vm,kvs_test@c50).
-define(Foreground,"./_build/default/rel/kvs_test/bin/kvs_test foreground").
-define(Daemon,"./_build/default/rel/kvs_test/bin/kvs_test daemon").
...
test1()->    
    ...
    %% Change
    42=rpc:call(?Vm,kvs_test,add,[20,22],5000),
...
setup()->
    ...
    %% Change
    pong=rpc:call(?Vm,kvs_test,ping,[],5000),
    ok.
